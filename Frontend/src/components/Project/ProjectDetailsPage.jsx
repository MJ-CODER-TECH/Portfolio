  ...
  if (error || !project) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center gap-6 text-center px-6">
        ...
        <button
          onClick={() => navigate(-1)}
          className="text-green-400 border border-green-400/30 px-5 py-2 rounded-lg text-sm hover:bg-green-400/10 transition"
        >
          ← Go Back
        </button>
      </div>
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2 flex flex-col gap-8">
          ...
          <div>
            <motion.p
              {...fadeUp(0.05)}
              className="text-green-400 text-xs uppercase tracking-[0.2em] mb-2"
            >
              Project
            </motion.p>
            <motion.h1
        ...
        <div className="flex flex-col gap-6">
          ...
          {project.techStack?.length > 0 && (
            <motion.div
              {...fadeUp(0.18)}
              className="bg-[#0d0d0d] border border-gray-800 rounded-xl p-6"
            >
              ...
              <div className="flex flex-wrap gap-2">
                {project.techStack.map((tech, i) => (
                  <span
                    key={i}
                    className="text-xs bg-green-400/10 text-green-400 border border-green-400/20 px-3 py-1.5 rounded-md"
                  >
                    {tech}
                  </span>
                ))}
          ...
          {project.category && (
            <motion.div
              ...
              className="bg-[#0d0d0d] border border-gray-800 rounded-xl p-6"
            >
              <h3 className="text-xs text-gray-500 uppercase tracking-widest mb-3">Category</h3>
          ...
          {project.status && (
            <motion.div
              ...
              className="bg-[#0d0d0d] border border-gray-800 rounded-xl p-6"
            >
              <h3 className="text-xs text-gray-500 uppercase tracking-widest mb-3">Status</h3>
              <span
          ...
          {project.year && (
            <motion.div
              ...
              className="bg-[#0d0d0d] border border-gray-800 rounded-xl p-6"
            >
              <h3 className="text-xs text-gray-500 uppercase tracking-widest mb-3">Year</h3>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20">
        ...
        {reviews.length > 0 ? (
          <div className="grid md:grid-cols-2 gap-6 mb-14">
            {reviews.map((r, i) => (
              <motion.div
                ...
                className="bg-[#0d0d0d] border border-gray-800 rounded-xl p-6 flex flex-col gap-3"
              >
                {/* Stars */}
                <div className="flex gap-1">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <span
                      key={s}
                      className={s <= r.rating ? "text-green-400" : "text-gray-700"}
                    >
                      ★
                    </span>
                  ))}
                ...
                <div className="flex items-center gap-3 mt-2">
                  {r.avatar ? (
                    ...
                    <div className="w-9 h-9 rounded-full bg-green-400/15 border border-green-400/20 flex items-center justify-center flex-shrink-0">
          ...
          /* Empty State */
          <div className="mb-14 text-center py-12 border border-dashed border-gray-800 rounded-xl">
        ...
        >
          {submitted ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-white font-semibold text-lg mb-2">Review Submitted!</p>
              <p className="text-gray-500 text-sm">
                Shukriya! Tera review admin approval ke baad dikhega.
              </p>
            </div>
          ) : (
            <>
              <h3 className="text-lg font-semibold mb-1">Leave a Review</h3>
              <p className="text-gray-500 text-sm mb-6">
                Is project ke baare mein apna experience share karo.
              </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  ...
                  className="bg-[#111] border border-gray-700 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-green-400/50 transition"
                />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    type="text"
                    placeholder="Your position (e.g. CEO)"
                    value={form.position}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600 text-xs">{form.rating}/5</span>
                </div>
                ...
                <textarea
                  ...
                  className="bg-[#111] border border-gray-700 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-green-400/50 transition resize-none"
                />
                ...
                <button
                  ...
                  className="bg-green-400 text-black px-6 py-3 rounded-lg font-semibold text-sm hover:scale-105 transition disabled:opacity-40 disabled:scale-100 disabled:cursor-not-allowed w-fit flex items-center gap-2"
                >
                  {reviewLoading ? (
                    <>
