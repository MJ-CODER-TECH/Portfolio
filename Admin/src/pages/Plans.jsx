...
const DURATION_LABEL = { month: '/ month', year: '/ year', 'one-time': 'one-time' };
    ...
    >
      <div className="bg-gray-800 border border-gray-700 rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-gray-400">Features * (one per line)</label>
            <textarea
...
const Plans = () => {
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">{plans.length} total plans</p>
        </div>
        <button
      ...
      /* Empty State */
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-gray-500 text-sm mt-1 mb-4">Create your first pricing plan.</p>
          <button
            onClick={() => setModal('add')}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan._id}
                className={`relative bg-gray-800 border rounded-2xl p-5 flex flex-col gap-4 transition
  ...
  {plan.title || plan.name}   {/* ✅ dono handle karo */}
                ...
                <div className="flex items-end gap-1">
                  ...
                  <span className="text-gray-400 text-sm mb-1">{DURATION_LABEL[plan.duration] || ''}</span>
                </div>
